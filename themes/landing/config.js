const CONFIG = {
  ...
  LANDING_HEADER_BUTTON_1_URL: 'https://github.com/Lookusluo/NotionNext',

  LANDING_HEADER_BUTTON_2_TITLE: '作者博客',
  LANDING_HEADER_BUTTON_2_URL: 'https://blog.Lookusluo.com/',

  // 首页大图英雄板块
  LANDING_HERO_TITLE_1: 'NotionNext',
  LANDING_HERO_P_1: '快速搭建独立站、轻松放大品牌价值！',
  LANDING_HERO_BUTTON_1_TEXT: '开始体验',
  LANDING_HERO_BUTTON_1_LINK: 'https://docs.Lookusluo.com/article/vercel-deploy-notion-next',
  LANDING_HERO_BUTTON_2_TEXT: '了解更多',
  LANDING_HERO_BUTTON_2_LINK: 'https://docs.Lookusluo.com/about',
  ...
  LANDING_POST_REDIRECT_URL: process.env.NEXT_PUBLIC_POST_REDIRECT_URL || 'https://blog.Lookusluo.com', // 重定向网站地址
  ...
  LANDING_PRICING_1_URL: 'https://docs.Lookusluo.com/about',
  ...
  LANDING_PRICING_2_URL: 'https://Lookusluo.lemonsqueezy.com/checkout/buy/0adb9153-0799-4f51-91aa-1f06391ea4e0',
  ...
  LANDING_PRICING_3_URL: 'https://Lookusluo.lemonsqueezy.com/checkout/buy/df924d66-09dc-42a4-a632-a6b0c5cc4f28',

  LANDING_NEWSLETTER: process.env.NEXT_PUBLIC_THEME_LANDING_NEWSLETTER || false // 是否开启邮件订阅 请先配置mailchimp功能 https://docs.Lookusluo.com/article/notion-next-mailchimp
}
