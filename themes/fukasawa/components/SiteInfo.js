...
function SiteInfo ({ title }) {
  ...
  return (
        ...
        >
            ...
            <br />
            <span className='text-xs font-serif'> Powered by <a href='https://github.com/Lookusluo/NotionNext' className='underline'>NotionNext {siteConfig('VERSION')}</a></span><br /></span>
            <h1>{title}</h1>
        </footer>
  )
}
