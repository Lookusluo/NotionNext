  ...
  return (
    ...
    >
      ...
      <span className='pl-2 hidden busuanzi_container_site_uv'>
        ...
        <br/>
        <h1>{title}</h1>
        <span className='text-xs font-serif'>Powered by <a href='https://github.com/Lookusluo/NotionNext' className='underline text-gray-500 dark:text-gray-300'>NotionNext {siteConfig('VERSION')}</a>.</span></span>
    </footer>
  )
}
