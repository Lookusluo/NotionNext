...
const CONFIG = {
  ...
  STARTER_HERO_BUTTON_1_URL: 'https://docs.Lookusluo.com/article/vercel-deploy-notion-next', // 英雄区按钮
  STARTER_HERO_BUTTON_2_TEXT: '在Github上关注', // 英雄区按钮
  STARTER_HERO_BUTTON_2_URL: 'https://github.com/Lookusluo/NotionNext', // 英雄区按钮
  ...
  STARTER_FEATURE_1_BUTTON_URL: 'https://github.com/Lookusluo/NotionNext', // 特性1

  STARTER_FEATURE_2_TITLE_1: '多种主题定制', // 特性2
  STARTER_FEATURE_2_TEXT_1: '数十种主题,适用于不同场景，总有一款适合你', // 特性2
  STARTER_FEATURE_2_BUTTON_TEXT: '了解更多', // 特性2
  STARTER_FEATURE_2_BUTTON_URL: 'https://docs.Lookusluo.com/article/notion-next-themes', // 特性2

  STARTER_FEATURE_3_TITLE_1: '优秀的性能', // 特性3
  STARTER_FEATURE_3_TEXT_1: '基于NextJS开发，更快的响应速度，更好的SEO', // 特性3
  STARTER_FEATURE_3_BUTTON_TEXT: '了解更多', // 特性3
  STARTER_FEATURE_3_BUTTON_URL: 'https://docs.Lookusluo.com/article/next-js', // 特性3

  STARTER_FEATURE_4_TITLE_1: '便捷的写作体验', // 特性4
  STARTER_FEATURE_4_TEXT_1: '只需在Notion笔记中编修，自动同步到网站', // 特性4
  STARTER_FEATURE_4_BUTTON_TEXT: '了解更多', // 特性4
  STARTER_FEATURE_4_BUTTON_URL: 'https://docs.Lookusluo.com/about', // 特性4
  ...
  STARTER_ABOUT_BUTTON_URL: 'https://docs.Lookusluo.com/about',
  ...
  STARTER_PRICING_1_BUTTON_URL: 'https://Lookusluo.lemonsqueezy.com/checkout/buy/c1a38a65-362e-44c5-8065-733fee39eb54',
  ...
  STARTER_PRICING_2_BUTTON_URL: 'https://Lookusluo.lemonsqueezy.com/checkout/buy/590ad70a-c3b7-4caf-94ec-9ca27bde06d4',
  ...
  STARTER_PRICING_3_BUTTON_URL: 'https://Lookusluo.lemonsqueezy.com/checkout/buy/df924d66-09dc-42a4-a632-a6b0c5cc4f28',
  ...
  STARTER_TESTIMONIALS_ITEMS: [
    ...
    {
      STARTER_TESTIMONIALS_ITEM_TEXT: '呜呜呜，经过一个下午的努力，终于把博客部署好啦，非常感谢Lookusluo大佬的框架和教程，这是我有生之年用过的最好用的博客框架┭┮﹏┭┮。从今之后，我就可以在自己的博客里bb啦，( •̀ ω •́ )y ',
  ...
  STARTER_FAQ_1_ANSWER: 'NotionNext提供了<a href="https://docs.Lookusluo.com/about" className="underline">帮助文档</a>，操作<a href="https://www.bilibili.com/video/BV1fM4y1L7Qi/" className="underline">演示视频</a>，以及<a href="https://docs.Lookusluo.com/article/chat-community" className="underline">交流社群</a>来协助您完成网站的搭建部署',

  STARTER_FAQ_2_QUESTION: '部署后要如何编写文章？',
  STARTER_FAQ_2_ANSWER: '您可以在Notion中之间添加或修改类型为Post的页面，内容将被实时同步在站点中，详情参考<a className="underline" href="https://docs.Lookusluo.com/article/start-to-write">《帮助文档》</a>',
  ...
  STARTER_TEAM_TEXT_2: 'NotionNext 由众多开源技术爱好者们共同合作完成，感谢每一位<a className="underline" href="https://github.com/Lookusluo/NotionNext/graphs/contributors">贡献者</a>',

  // 这里不支持CONFIG和环境变量，需要一一修改此处代码。
  STARTER_TEAM_ITEMS: [
    {
      STARTER_TEAM_ITEM_AVATAR: 'https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2Fa06c61bb-980e-4180-bc18-c15f92c78bb4%2FLookusluo.jpg?table=collection&id=8e7acf17-de09-4fa1-abde-b5b80ad4a813&t=8e7acf17-de09-4fa1-abde-b5b80ad4a813&width=100&cache=v2',
      STARTER_TEAM_ITEM_NICKNAME: 'luke',
  ...
  STARTER_CONTACT_EMAIL_TEXT: 'mail@Lookusluo.com',
  ...
  STARTER_FOOTER_LINK_GROUP: [
    {
      ...
      LINK_GROUP: [
        { TITLE: '官方主页', URL: '/#home' },
        { TITLE: '操作文档', URL: 'https://docs.Lookusluo.com/about' },
        { TITLE: '帮助支持', URL: 'https://docs.Lookusluo.com/article/how-to-question' },
        { TITLE: '合作申请', URL: 'https://docs.Lookusluo.com/article/my-service' }
      ]
    },
    {
      TITLE: '功能特性',
      LINK_GROUP: [
        { TITLE: '部署指南', URL: 'https://docs.Lookusluo.com/article/vercel-deploy-notion-next' },
        { TITLE: '升级指南', URL: 'https://docs.Lookusluo.com/article/how-to-update-notionnext' },
        { TITLE: '最新版本', URL: 'https://docs.Lookusluo.com/article/latest' }
      ]
    },
    {
      TITLE: 'Notion写作',
      LINK_GROUP: [
        { TITLE: 'Notion开始写作', URL: 'https://docs.Lookusluo.com/article/start-to-write' },
        { TITLE: '快捷键提升效率', URL: 'https://docs.Lookusluo.com/article/notion-short-key' },
        { TITLE: '中国大陆使用Notion', URL: 'https://docs.Lookusluo.com/article/notion-faster' }
      ]
    }
  ],
  ...
  STARTER_POST_REDIRECT_URL: 'https://blog.Lookusluo.com', // 重定向域名
  STARTER_NEWSLETTER: process.env.NEXT_PUBLIC_THEME_STARTER_NEWSLETTER || false // 是否开启邮件订阅 请先配置mailchimp功能 https://docs.Lookusluo.com/article/notion-next-mailchimp
}
