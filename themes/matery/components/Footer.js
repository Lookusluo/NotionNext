  ...
  return (
    ...
    >
      ...
      <span className='pl-2 hidden busuanzi_container_site_uv'>
        ...
        <br/>
        <h1>{title}</h1>
        <span className='text-xs '>Powered by <a href='https://github.com/Lookusluo/NotionNext' className='underline dark:text-gray-300'>NotionNext {siteConfig('VERSION')}</a>.</span></span><br/>
